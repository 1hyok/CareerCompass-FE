...
```
$ adb shell dumpsys package com.cambridge.careercompass_fe | grep versionName
    versionName=1.0
```
...
```bash
adb -s <serial> shell dumpsys package com.cambridge.careercompass_fe | grep lastUpdateTime
```
...
avdmanager create avd -n CareerCompass_QA_API26 -k "system-images;android-26;google_apis;arm64-v8a"
```
