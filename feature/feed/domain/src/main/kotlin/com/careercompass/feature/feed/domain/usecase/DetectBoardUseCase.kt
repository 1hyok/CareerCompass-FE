...
import com.careercompass.feature.feed.domain.model.BoardUrl
 ...
 *
 * 형태가 잘못된 입력은 요청 없이 [FeedFailure.InvalidBoardUrl][com.careercompass.feature.feed.domain.error.FeedFailure.InvalidBoardUrl]
 * 로 실패한다(규칙은 [BoardUrl]).
 */
