...
function collectIssues(pr, repository = "1hyok/CareerCompass-FE") {
...
function collectRefreshHeads(prs, blocked, repository = "1hyok/CareerCompass-FE") {
...
test("closing references and same-repository close keywords are inspected as a union", () => {
    const issues = collectIssues({
        title: "fix: resolves #9 and Fixes 1hyok/careercompass-fe#10",
        body: "Closes other/repo#11\n- fixed #12\nmentions #13 only\nClosed #12",
        closingIssuesReferences: {
            nodes: [
                { number: 8, repository: { nameWithOwner: "1hyok/CareerCompass-FE" } },
        ...
        [
            {
                ...
                closingIssuesReferences: {
                    nodes: [
                        { number: 1176, repository: { nameWithOwner: "1hyok/CareerCompass-FE" } },
                    ],
                },
            },
            {
