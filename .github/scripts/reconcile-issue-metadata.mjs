...
// 새 저장소라 정책 도입 이전 백로그가 없다. 1번 이슈부터 fail-closed 로 관리한다.
export const LEGACY_ISSUE_MAX = 0;
...
export const AREA_LABEL_BY_MODULE = Object.freeze({
    careercompass: "area:careercompass",
    ...
    return async function api(apiPath, { method = "GET", body } = {}) {
        const response = await fetch(`https://api.github.com${apiPath}`, {
            ...
            headers: {
                ...
                "user-agent": "CareerCompass-issue-metadata-guard",
