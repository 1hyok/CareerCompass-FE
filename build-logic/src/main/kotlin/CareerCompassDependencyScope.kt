...
internal fun Project.careerCompassDependencies(block: CareerCompassDependencyScope.() -> Unit) {
    dependencies {
        CareerCompassDependencyScope(this@careerCompassDependencies, this).apply(block)
    }
}

internal class CareerCompassDependencyScope(
