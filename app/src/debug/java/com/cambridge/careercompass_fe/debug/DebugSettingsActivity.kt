package com.cambridge.careercompass_fe.debug
...
import com.cambridge.careercompass_fe.MainActivity

/**
 * 디버그 빌드 전용 진입점. 런처 아이콘을 늘리지 않으려고 LAUNCHER intent-filter 는 두지 않는다.
 *
 * `adb shell am start -n com.cambridge.careercompass_fe/.debug.DebugSettingsActivity`
 *
